 ...
 * same {@code payment-service} consumer group / single-partition topic, causing
 * flaky partition assignment across test classes. Extending this common base
 * keeps the {@code Method} identity shared, so the context (and its listener) is
 * cached and reused across {@link PaymentSagaIT} and {@link DeadLetterIT}.
 */
